    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <p class="payment_module">
                <a class="bankwire" onclick="createOrder();" title="{$title_payee}" style="line-height: 100%;">
                    {$showlogo}
                    <span style="float:right;  font-size: 14px;">{$description_user}</span><br style="clear:both;"/>
                </a>
            </p>
